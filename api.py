...
trackers_post_args.add_argument(
...
trackers_update_args.add_argument(
    "tracker_name", type=str, help="Name of the tracker is required", required=True)
trackers_update_args.add_argument(
    "description", type=str, help="description of the tracker is required", required=True)
...
numerical_args.add_argument("tracker_value", type=int,
                            help="value of the tracker log is required", required=True)
numerical_args.add_argument(
...
# API: TRACKER: CREATE
    ...
    def post(self, user_id):
        ...
        newT = Tracker(user_id=user_id, tracker_name=args['tracker_name'],
...
type_dict = {'numerical': Tracker_Numerical, 'multiple_choice': Tracker_multi_choice,
             'boolean': Tracker_boolean, 'time_duration': Tracker_Numerical}
logs_json_dict = {'numerical': tracker_numerical_json, 'multiple_choice': tracker_multichoice_json,
                  'boolean': tracker_boolean_json, 'time_duration': tracker_numerical_json}

logType = {Tracker_Numerical: numerical_args,
           Tracker_multi_choice: multi_args, Tracker_boolean: bool_args}
# API: LOGS: CRUD
# API: LOG: READ, CREATE
